      ...
      <Grid container className={classes.item}>
        <Grid item xs={3} className={classes.item}>
          <TextInput
            ...
            readOnly
            placeholder={benefitPlan?.id ? '' : formatMessage(intl, 'socialProtection', 'benefitPlan.code.autoGenerated')}
            helperText={formatMessage(intl, 'socialProtection', 'benefitPlan.code.hint.generatedOnSave')}
